...
public class TestMetier {
	...
	public static void testCrediterDebiterJoueur () {
		...
		// tests débiter un perdant ou créditer un gagnant 
		try {
					...
					// créditer incorrectement un joueur
					
					try {
						siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), 10, new String("abcd"));
						System.out.println("créditer un joueur avec un  password gestionnaire invalide n'a pas levé l'exception MetierException");
					}
					catch (MetierException e) { }
					catch (Exception e) { 
						System.out.println("créditer un joueur avec un  password gestionnaire invalide n'a pas levé l'exception MetierException mais " + e.getClass().getName());
					}

					try {
						siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), 10, new String("ilesVierges"));
						System.out.println("créditer un joueur avec un  password gestionnaire incorrect n'a pas levé l'exception MetierException");
					}
					catch (MetierException e) { }
					catch (Exception e) { 
						System.out.println("créditer un joueur avec un  password gestionnaire incorrect n'a pas levé l'exception MetierException mais " + e.getClass().getName());
					}
					
					try {
						siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), -10, new String("ilesVierges"));
						System.out.println("créditer un joueur avec une somme en jetons négative n'a pas levé l'exception MetierException");
					}
					catch (MetierException e) { }
					catch (Exception e) { 
						System.out.println("créditer un joueur avec une somme en jetons négative n'a pas levé l'exception MetierException mais " + e.getClass().getName());
					}
					
					try {
						siteDeParisMetier.crediterJoueur(new String("lolita"), new String("avfrqwxx"), new String("tryui"), 10, new String("ilesCaimans"));
						System.out.println("créditer un joueur inexistant n'a pas levé l'exception JoueurInexistantException");
					}
					catch (JoueurInexistantException e) { }
					catch (Exception e) { 
						System.out.println("créditer un joueur inexistant n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
					}
               
               
               
               try {
						siteDeParisMetier.crediterJoueur(new String("Prou a"), new String("Bernard"), new String("nanard"), 10, new String("ilesCaimans"));
						System.out.println("créditer un joueur avec nom invalide n'a pas levé l'exception JoueurException");
					}
					catch (JoueurException e) { }
					catch (Exception e) { 
						System.out.println("créditer un joueur avec nom invalide n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
					}
               try {
				      siteDeParisMetier.crediterJoueur(new String("Prou"),null, new String("nanard"), 10, new String("ilesCaimans"));
      			...
      			try {
      				siteDeParisMetier.crediterJoueur(null, new String("Bernard"), new String("nanard"), 10, new String("ilesCaimans"));
      			...
      			try {
      				siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard"), null, 10, new String("ilesCaimans"));
      			...
      			try {
      				siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), 10, null);
      			...
      			try {
      				siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard a"), new String("nanard"), 10, new String("ilesCaimans"));
      			...
      			try {
      				siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard"), new String("na"), 10, new String("ilesCaimans"));
      			...
      			try {
      				siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard"), new String("na.nard"), 10, new String("ilesCaimans"));
					...
					//créditer correctement un joueur
					siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), 10, new String("ilesCaimans"));
					
					//débiter correctement un joueur
					try {
						siteDeParisMetier.debiterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), 5, new String("ilesCaimans"));
					}
					catch (JoueurException e) { System.out.println("créditer correctement un joueur n'a pas fonctionné");}

					//débiter incorrectement un joueur
					try {
						siteDeParisMetier.debiterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), 20, new String("ilesCaimans"));
						System.out.println("débiter un joueur d'une somme supèrieure à son solde n'a pas levé l'exception JoueurException");
					}
					catch (JoueurException e){ }
					catch (Exception e) { System.out.println("débiter un joueur d'une somme supèrieure à son solde n'a pas levé l'exception JoueurException mais " + e.getClass().getName());}

               try {
						siteDeParisMetier.debiterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), 3, new String("abcd"));
						System.out.println("débiter un joueur avec un  password gestionnaire invalide n'a pas levé l'exception MetierException");
					}
					catch (MetierException e) { }
					catch (Exception e) { 
						System.out.println("débiter un joueur avec un  password gestionnaire invalide n'a pas levé l'exception MetierException mais " + e.getClass().getName());
					}
               
               try {
						siteDeParisMetier.debiterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), 3, new String("ilesVierges"));
						System.out.println("débiter un joueur avec un  password gestionnaire incorrect n'a pas levé l'exception MetierException");
					}
					catch (MetierException e) { }
					catch (Exception e) { 
						System.out.println("débiter un joueur avec un  password gestionnaire incorrect n'a pas levé l'exception MetierException mais " + e.getClass().getName());
					}
   
               try {
						siteDeParisMetier.debiterJoueur(new String("lolita"), new String("avfrqwxx"), new String("tryui"), 10, new String("ilesCaimans"));
						System.out.println("débiter un joueur inexistant n'a pas levé l'exception JoueurInexistantException");
					}
					catch (JoueurInexistantException e) { }
					catch (Exception e) { 
						System.out.println("débiter un joueur inexistant n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
					}
               
               try {
						siteDeParisMetier.debiterJoueur(new String("Prou a"), new String("Bernard"), new String("nanard"), 10, new String("ilesCaimans"));
						System.out.println("débiter un joueur avec nom invalide n'a pas levé l'exception JoueurException");
					}
					catch (JoueurException e) { }
					catch (Exception e) { 
						System.out.println("débiter un joueur avec nom invalide n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
					}
               
               try {
						siteDeParisMetier.debiterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), -10, new String("ilesVierges"));
						System.out.println("débiter un joueur avec une somme en jetons négative n'a pas levé l'exception MetierException");
					}
					catch (MetierException e) { }
					catch (Exception e) { 
						System.out.println("débiter un joueur avec une somme en jetons négative n'a pas levé l'exception MetierException mais " + e.getClass().getName());
					}
	...
	public static void testMiserVainqueur () {
		...
		try {
			...
			// miser incorrectement
			try {
				siteDeParisMetier.miserVainqueur(null, new String(passwdBernard), 100, new String("ChampionnatDeFrance2012"), new String("Lyon"));
				System.out.println("miser avec un pseudo non instancié n'a pas leve l'exception JoueurException");
			} 
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("miser avec un psudo non instancié n'a pas leve l'exception JoueurException mais " + e.getClass().getName());
			}
         
         try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), null, 100, new String("ChampionnatDeFrance2012"), new String("Lyon"));
				System.out.println("miser un mdp non instancié n'a pas leve l'exception JoueurException");
			} 
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("miser avec un mdp non instancié n'a pas leve l'exception JoueurException mais " + e.getClass().getName());
			}
         
         try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String("nananard") , 100, new String("ChampionnatDeFrance2012"), new String("Lyon"));
				System.out.println("miser un mdp incorrect n'a pas leve l'exception JoueurException");
			} 
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("miser avec un mdp incorrect n'a pas leve l'exception JoueurException mais " + e.getClass().getName());
			}
         
         try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard) , -100, new String("ChampionnatDeFrance2012"), new String("Lyon"));
				System.out.println("miser une somme négative n'a pas leve l'exception MetierException");
			} 
			catch (MetierException e) { }
			catch (Exception e) { 
				System.out.println("miser avec une somme négative n'a pas leve l'exception MetierException mais " + e.getClass().getName());
			}         


				
         try {
				siteDeParisMetier.miserVainqueur(new String("nan ard"), new String(passwdBernard), 100, new String("ChampionnatDeFrance2012"), new String("Lyon"));
				System.out.println("miser avec un pseudo invalide n'a pas leve l'exception JoueurException");
			} 
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("miser avec un pseudo invalide n'a pas leve l'exception JoueurException mais " + e.getClass().getName());
			}
         
         try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String("1234"), 100, new String("ChampionnatDeFrance2012"), new String("Lyon"));
				System.out.println("miser avec un mdp invalide n'a pas leve l'exception JoueurException");
			} 
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("miser avec un mdp invalide n'a pas leve l'exception JoueurException mais " + e.getClass().getName());
			}
      
        try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 100,  null , new String("Lyon"));
				System.out.println("miser avec une compétition non instanciée n'a pas leve l'exception CompetitionException");
			} 
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("miser avec une compétition non instanciée n'a pas leve l'exception CompetitionException mais " + e.getClass().getName());
			}
         
         try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 100, new String("ChampionnatDeFrance2012"), null);
				System.out.println("miser avec un compétiteur non instancié n'a pas leve l'exception CompetitionException");
			} 
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("miser avec un compétiteur non instancié n'a pas leve l'exception CompetitionException mais " + e.getClass().getName());
			}
         
         try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 100, new String("ChampionnatDeFrance2012"), new String("Lyo"));
				System.out.println("miser avec un nom de compétiteur invalide n'a pas leve l'exception CompetitionException");
			} 
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("miser avec un nom de compétiteur invalide n'a pas leve l'exception CompetitionException mais " + e.getClass().getName());
			}
         
        

			try {
				siteDeParisMetier.miserVainqueur(new String("tryui"), new String("jbjbjbjba"), 10, new String("finaleRG2012"), new String("nadal"));
				System.out.println("miser avec un joueur inexistant n'a pas levé l'exception JoueurInexistantException");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
				System.out.println("miser avec un joueur inexistant n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 100,new String("ChampionnatDeRance2012"),new String("Marseille"));
				System.out.println("miser sur une compétition inexistante sans lever CompetitionInexistanteException");
			}
			catch (CompetitionInexistanteException e) { }
			catch (Exception e) { 
				System.out.println("miser sur une compétition inexistante sans lever CompetitionInexistanteException mais " + e.getClass().getName());
			}
			
			DateFrancaise.setDate(1, 1, 2014);
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 100,new String("finaleRG2012"),new String("Nadal"));
				System.out.println("miser sur une compétition terminée sans lever CompetitionException");
			} 
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("miser sur une compétition terminée sans lever CompetitionException mais " + e.getClass().getName());
			}
			
			DateFrancaise.setDate(1, 1, 2010);
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 100, new String("finaleRG2012"), new String("Federer"));
				System.out.println("miser sur une compétition avec un vainqueur inexistant sans lever CompetitionException");
			} 
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("miser sur une compétition avec un vainqueur inexistant sans lever CompetitionException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 2000, new String("finaleRG2012"), new String("Nadal"));
				System.out.println("miser sur une compétition avec un solde insuffisant sans lever JoueurException");
			} 
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("miser sur une compétition avec un solde insuffisant sans lever JoueurException mais " + e.getClass().getName());
			}
         //miser correctement
         siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 1000, new String("finaleRG2012"), new String("Nadal"));
         try {
...
e.printStackTrace();
	...
	public static void testSolderVainqueur () {
		...
		try {
			...
			//  nanard doit avoir un crédit de 1789
